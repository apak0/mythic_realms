  ...
  const paths = [
    {
      ...
      description: 'Explore the rich history, mystical locations, and legendary tales that shape the realms. Uncover secrets hidden in ancient texts and maps.',
    ...
    },
    {
      ...
      description: 'Connect with adventurers from across all realms. Form guilds, share epic moments, and forge friendships that transcend worlds.',
    ...
    },
    {
      ...
      description: 'Rise through the ranks and claim your place among legends. Compete in tournaments, climb leaderboards, and earn eternal glory.',
      image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop',
      icon: 'Sword',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full mb-6">
            ...
            <span className="font-inter text-sm text-primary">Choose Your Destiny</span>
          </div>
          ...
          <p className="font-inter text-xl text-muted-foreground max-w-3xl mx-auto">
            Every great adventure begins with a choice. Which path calls to your heroic spirit?
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {paths?.map((path, index) => (
            <Link
              key={path?.id}
              to={path?.route}
              className="group relative overflow-hidden rounded-2xl bg-card border border-border hover:border-primary/50 smooth-transition mystical-hover"
            >
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-t ${path?.color} to-transparent`} />
                <div className="absolute inset-0 bg-gradient-to-t from-card/90 via-transparent to-transparent" />
                
                <div className="absolute top-4 right-4">
                  <div className={`w-12 h-12 bg-background/80 backdrop-blur-sm rounded-lg flex items-center justify-center border ${path?.borderColor}`}>
                ...
                <div className="absolute bottom-4 left-4">
                  <div className="flex items-center space-x-2 px-3 py-1 bg-background/80 backdrop-blur-sm rounded-full border border-border">
                    ...
                    <span className="font-inter text-xs text-foreground">{path?.stats}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2 text-primary group-hover:translate-x-2 smooth-transition">
                    <span className="font-inter text-sm font-medium">Enter</span>
        ...
        <div className="text-center mt-12">
          <p className="font-inter text-muted-foreground mb-6">
            Not sure where to start? Take our quick assessment to find your ideal path.
          </p>
