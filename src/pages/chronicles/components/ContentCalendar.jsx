  ...
  const upcomingContent = [
    {
      ...
      time: "14:00 UTC",
      description:
        "Join our lead developers as they reveal the mysteries of the upcoming Shadowlands expansion.",
      status: "scheduled",
      attendees: 1247,
    },
    {
      ...
      time: "16:00 UTC",
      description:
        "Celebrating the incredible artistic talents of our community members.",
      status: "confirmed",
      attendees: 892,
    },
    {
      ...
      time: "12:00 UTC",
      description:
        "Comprehensive overview of gameplay balance changes and technical improvements.",
      status: "draft",
      attendees: 0,
    },
    {
      ...
      time: "15:00 UTC",
      description:
        "Master the art of legendary weapon crafting with tips from top players.",
      status: "scheduled",
      attendees: 634,
    },
  ];
  ...
  return (
    <div className="bg-card border border-border rounded-lg p-6">
              ...
              <div className="flex items-start justify-between mb-2">
                <div>
                  ...
                  <div className="flex items-center space-x-3 mt-1">
                    ...
                    <span
                      className={`px-2 py-1 rounded text-xs font-inter font-medium border ${getStatusColor(
                        content?.status
                      )}`}
                    >
      ...
      <div className="mt-6 pt-4 border-t border-border">
          ...
          <div className="flex items-center space-x-4 text-sm text-muted-foreground">
            <div className="flex items-center space-x-1">
              ...
              <span className="font-inter">
                {upcomingContent?.length} upcoming
              </span>
            </div>
            <div className="flex items-center space-x-1">
        ...
        <div className="flex flex-col justify-center space-x-2 mt-2">
